...
namespace PlayLayer_Origins {
	void(*cameraMoveX)(PlayLayer*, float, float, float);
	void(*cameraMoveY)(PlayLayer*, float, float, float);
	void(*shakeCamera)(PlayLayer*, float, float, float);
	void(*showNewBest)(PlayLayer*, bool, int, int, bool, bool, bool);
	void(*showEndLayer)(PlayLayer*);
	void(*updateCamera)(PlayLayer*, float);
	void(*destroyPlayer)(PlayLayer*, PlayerObject*, GameObject*);
	void(*levelComplete)(PlayLayer*);
	void(*spawnFirework)(PlayLayer*);
	void(*showRetryLayer)(PlayLayer*);
	void(*moveCameraToPos)(PlayLayer*, cocos2d::CCPoint);
